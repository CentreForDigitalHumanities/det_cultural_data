...
- **"Following and clicking":** you can go through the analysis step by step together with the instructor. Data will be shared on Google drive and you will be guided through the analysis on Google Colab. You would not need to install anything, just having a Google account;
